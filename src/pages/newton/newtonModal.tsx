...
export function NewtonModal(props: {
    ...
    return (
        <Modal show={props.showModal}>
            ...
            <TeX math="z_{t+1} \gets z_t - \frac{f(z)}{f^\prime(z)}" block={true} />
            <p>
                to points in the complex plane. By coloring each point according to the root found and number of
                iterations required, interesting images emerge. Enter some function, and press explore!
            </p>
            ...
            <TeX math={props.texExpression} block={true} />
            <p>and its derivative is</p>
            <TeX math={props.differentiatedTexExpression} block={true} />
            <a className="a-text-btn" style={{ float: "right" }} onClick={props.onClose}>
                Explore
            </a>
        </Modal>
    );
