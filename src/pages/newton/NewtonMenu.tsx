    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <input value={props.maxIterations} onChange={props.onMaxIterationsChange} />
            </div>
            <div>
                <h2>Method</h2>
                <select value={props.method} onChange={(e) => props.onMethodChange(e.currentTarget.value)}>
            ...
            <div>
                ...
                <TeX math="z_{t+1} \gets z_t - a h + c" block={true} />
                <div
                    style={{
                        display: "grid",
                        gridTemplateColumns: "10% 15% 5% 15% 5%",
                    }}
                >
