...
export class LSystemContainer extends React.Component<LSystemProps, LSystemState> {
  ...
  componentDidMount() {
    ...
    document.getElementById('next-bg')!.addEventListener('click', this.nextLevel, {passive: false});
    document.getElementById('prev-bg')!.addEventListener('click', this.resetLevel, {passive: false});
  ...
  componentWillUnmount() {
    ...
    document.getElementById('next-bg')!.removeEventListener('click', this.nextLevel);
    document.getElementById('prev-bg')!.removeEventListener('click', this.resetLevel);
  }
